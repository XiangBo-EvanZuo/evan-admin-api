package cn.evanzuo.admin.oauth2.cas.mapper;
...
import cn.evanzuo.admin.oauth2.cas.domain.entity.RoleItem;
...
public interface UserMapper extends BaseMapper<User> {
    ...
    @Select("select tb_wang_role.role_name, tb_wang_role.value from tb_wang_role " +
